...
saving_indices , training_images , test_images = load_imgs.load_images_from_folder(folder)
...
classifier.show_predicted_image(RFC ,mean_image,eigen_vectors, saving_indices)
